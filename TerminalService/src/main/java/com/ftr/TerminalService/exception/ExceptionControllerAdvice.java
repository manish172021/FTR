...
import com.ftr.TerminalService.model.ErrorResponse;
...
public class ExceptionControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(TerminalsException.class)
    public ResponseEntity<ErrorResponse> handleTerminalException(TerminalsException exception) {
        HttpStatus errorCode = HttpStatus.NOT_FOUND;
        if (exception.getMessage().equals("terminal.empty")) {
            errorCode = HttpStatus.NOT_FOUND;
        } else if (exception.getMessage().equals("terminal.notFound")) {
            errorCode = HttpStatus.NOT_FOUND;
        }else if (exception.getMessage().equals("terminal.capacity.failed")) {
            errorCode = HttpStatus.BAD_REQUEST;
        } else if (exception.getMessage().equals("terminal.itemtype.notFound")) {
            errorCode = HttpStatus.NOT_FOUND;
        } else if (exception.getMessage().equals("terminal.already.deleted")) {
